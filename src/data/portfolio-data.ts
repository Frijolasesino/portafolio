export const portfolioData = {
  ...
  // Introducción
  intro: {
    title: "Hi there, my name is Alejandro!",
    description:
  ...
  projects: [
    {
      ...
      image: "descarga (1).jpeg", // You'll need to add these images to your public folder
    ...
    },
    {
      ...
      description:
        "A full-featured social platform with real-time messaging and content sharing",
      image: "descarga.jpeg",
    ...
    },
    {
      ...
      description:
        "A beautiful weather app with detailed forecasts and interactive maps",
  ...
  services: [
    {
      ...
      description:
        "Crafting responsive and performant web applications using modern technologies and best practices. Specialized in React and TypeScript development with a focus on user experience and accessibility.",
      details: [
    ...
    },
    {
      ...
      title: "UI/UX DESIGN",
      description:
        "Creating intuitive and engaging user interfaces that provide exceptional user experiences. Focus on modern design principles and accessibility.",
      details: [
